...
public class Problema3m {
    ...
    public static char[] n; //array de caracteres n
    ...
    public static void arrayAleatorio() {
        ...
        for (int i = 0; i < ar.length; i++) {   //para todo i menor que la longitud del array ar
            ar[i] = (char) (Math.random() * 26 + 97);   //se guarda en ar[i] un caracter aleatorio del alfabeto
        }
        for (int i = 0; i < ar.length; i++) {   //para todo i menor que la longitud del array ar
    ...
    //metodo que pide que se introduzca el nombre por teclado y lo convierte a un array de caracteres que guarda en n
    public static void nombre() {

        Scanner sc = new Scanner(System.in);

        System.out.println("Introduzca su nombre: ");
        String nombre = sc.next();  //guarda el nombre introducido por pantalla en el String nombre
        n = nombre.toCharArray();   //convierte el String en un array de caracteres y lo guarda en n

    }

    //metodo que busca mi nombre
    public static void buscar() {
        nombre();   //llama al metodo nombre 
